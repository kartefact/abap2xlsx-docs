    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Excel Tables', link: '/guide/excel-tables' },
          { text: 'Named Ranges', link: '/guide/named-ranges' },
          { text: 'Data Validation', link: '/guide/data-validation' },
          { text: 'Ignored Errors', link: '/guide/ignored-errors' },
          { text: 'Cell Comments', link: '/guide/cell-comments' },
          { text: 'Autofilter', link: '/guide/autofilter' },
          { text: 'Row / Column Grouping', link: '/guide/row-column-grouping' },
          { text: 'Images', link: '/guide/images' },
          { text: 'Charts', link: '/guide/charts' },
          { text: 'Template Filling', link: '/guide/template-filling' },
          { text: 'Reading Excel', link: '/guide/reading-excel' },
          { text: 'Convert to Table', link: '/guide/convert-to-table' },
          { text: 'ALV Integration', link: '/guide/alv-integration' },
          { text: 'ALV Converter', link: '/guide/alv-converter' },
          { text: 'CSV Export', link: '/guide/csv-export' },
          { text: 'XLSM Macros', link: '/guide/xlsm-macros' },
          { text: 'Data Conversion', link: '/guide/data-conversion' },
          { text: 'Style Changer', link: '/guide/style-changer' },
          { text: 'Workbook Security', link: '/guide/workbook-security' },
          { text: 'Huge File Writer', link: '/guide/huge-file-writer' },
          { text: 'OLE / On-Screen Converter', link: '/guide/ole-converter' },
